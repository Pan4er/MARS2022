...
// Горючее
  gg,                          // скмасса горючего на конец кампании
...
begin
     ...
     begin
      ...
      Wsheet.Range['b2'].Value:='Эффективный коэффициент размножения нейтронов';
      Wsheet.Range['b3'].Value:='Коэффициент использования тепловых нейтронов';
      Wsheet.Range['b4'].Value:='Коэффициент размножения на быстрых нейтронах';
      Wsheet.Range['b5'].Value:='Вероятность избежать резонансного захвата';
      Wsheet.Range['b6'].Value:='Вероятность избежать утечки для тепловых нейтронов';
      Wsheet.Range['b7'].Value:='Вероятность избежать утечки для быстрых нейтронов';
      Wsheet.Range['b8'].Value:='Обогащение';
      Wsheet.Range['b9'].Value:='Масса урана - 235, кг';
      Wsheet.Range['b10'].Value:='Масса горючего, кг';
      Wsheet.Range['b11'].Value:='Масса плутония, кг';
      Wsheet.Range['b12'].Value:='Доля горючего в топливной композиции';
      Wsheet.Range['b13'].Value:='Нейтронный поток *Е-13, н/(см2*с)';
      Wsheet.Range['b14'].Value:='Температура нейтронного газа, град.К';
      Wsheet.Range['b15'].Value:='Возраст нейтронов в АЗ, см2';
      Wsheet.Range['b16'].Value:='Концентрация ядер урана-235 *Е-03, см3';
      Wsheet.Range['b17'].Value:='Концентрация ядер урана-238 *Е-03, см3';
